...
CREATE TABLE Patient (
  ...
  InsuranceID INTEGER NOT NULL,
  PCP INTEGER NOT NULL,
    CONSTRAINT fk_Physician_EmployeeID FOREIGN KEY(PCP) REFERENCES Physician(EmployeeID)
);
...
CREATE TABLE On_Call (
  Nurse INTEGER NOT NULL,
    CONSTRAINT fk_Nurse_EmployeeID  FOREIGN KEY(Nurse) REFERENCES Nurse(EmployeeID),
  BlockFloor INTEGER NOT NULL,
  BlockCode INTEGER NOT NULL,
  Start DATETIME NOT NULL,
  End DATETIME NOT NULL,
...
CREATE TABLE Undergoes (
  ...
  Physician INTEGER NOT NULL,
    CONSTRAINT fk_Physician_EmployeeID FOREIGN KEY(Physician) REFERENCES Physician(EmployeeID),
  AssistingNurse INTEGER,
    CONSTRAINT fk_Nurse_EmployeeID FOREIGN KEY(AssistingNurse) REFERENCES Nurse(EmployeeID),
